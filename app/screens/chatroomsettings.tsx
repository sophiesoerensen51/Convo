...
const ChatRoomSettings = ({ route, navigation }) => {
    ...
    const renderUserItem = ({ item }) => {
        ...
        const isUserAdmin = admins.some(admin => admin.id === item.id);
    ...
    const renderSelectAllItem = () => (
        <SelectAllItem 
            ...
            onPress={isAdmin ? toggleSelectAll : undefined} 
            disabled={!isAdmin} 
        />
    );
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Vis admins liste ALDRIG KUN FOR ADMIN */}
            {admins.length > 0 && (
